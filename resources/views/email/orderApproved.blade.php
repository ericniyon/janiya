...
@endforeach --}}
  <table width="100%">
    <tr>
      ...
      <td width="300px"><div style="background: #670A25;border-left: 15px solid #fff;padding-left: 30px;font-size: 26px;font-weight: bold;letter-spacing: -1px;height: 73px;line-height: 75px; color:#fff">Order Confirmation</div></td>
      <td></td>
    </tr>
  </table>
  <br><br>
  <h3>  <h1><u>Order status</u>: {{ $order->status }} </h1></h3>
  {{-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p> --}}
  <br>
  {{-- <table width="100%" style="border-collapse: collapse;">
    <tr>
      <td widdth="50%" style="background:#eee;padding:20px;">
        <strong>Date:</strong> {{ $store->created_at }}<br>
        <strong>Store Name:</strong> {{ $store->shop->name }}<br>
        <strong>Shop Name:</strong> {{ $store->shop->shop_name }}<br>
      </td>
       <br><br>
      <td style="background:#eee;padding:20px;">
        <strong>Order-nr:</strong> {{ $orderNo }}<br>
        <strong>E-mail:</strong> {{ $store->shop->email }}<br>
        <strong>Phone:</strong> {{ $store->shop->phone }}<br>
      </td>
    </tr>
  </table><br> --}}
  <br>
      ...
      <td>
        <table width="300px" style="float:right">
          <tr>
            ...
            <td style="text-align:right">{{ $totals }}Rwf   </td>
