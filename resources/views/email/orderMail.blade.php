...
@endforeach
  <table width="100%">
    <tr>
      ...
      <td width="300px"><div style="background: #670A25;border-left: 15px solid #fff;padding-left: 30px;font-size: 26px;font-weight: bold;letter-spacing: -1px;height: 73px;line-height: 75px; color:#fff">Order invoice</div></td>
      <td></td>
    </tr>
  </table>
  <br><br>
  <h3>  <h1><u>Order status</u>: {{ $status }}</h1></h3>
  ...
  <h3>Detailed Order</h3>
   ...
   <table width="100%" style="border-collapse: collapse;border-bottom:1px solid #eee;">
    ...
    @endphp
     ...
     @foreach ($store->valiations as $item)
     <tr>
