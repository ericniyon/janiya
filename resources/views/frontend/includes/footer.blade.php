        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xl-3">
                    <div class="footer-widget"><a class="footer-logo" href="#"><img src="{{ asset('front/images/gologo.png') }}"
                                alt="logo"></a>
                    ...
                    <div class="footer-widget contact">
                        ...
                        <ul class="footer-contact">
                            <li><i class="icofont-ui-email"></i>
                                <p><span>support@gogreen.rw</span><span>info@gogreen.rw</span></p>
                            </li>
                            <li><i class="icofont-ui-touch-phone"></i>
                                <p><span>+250 787 399 228</span><span>+250 782 507 049</span></p>
                            </li>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="footer-widget">
                        ...
                        <div class="footer-app"><a href="#"><img src="{{ asset('front/images/google-store.png') }}"
                                    alt="google"></a><a href="#"><img src="{{ asset('front/images/app-store.png') }}"
                                    alt="app"></a></div>
                    </div>
                </div>
            </div>
