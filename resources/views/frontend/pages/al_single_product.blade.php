@extends('frontend.pages.details_base')
@section('title')
                ...
                <div class="col-md-6">
                    <div id="slider" class="owl-carousel product-slider">
                        ...
                        @foreach ($product->attributes as $image)
                            <div class="item" >
                                <img src="{{ $image->image ? asset('storage/'.$image->image) : asseet('storage/'.$image->product_image) }}" />
                            </div>
                        @endforeach
                    ...
                    <div id="thumb" class="owl-carousel product-thumb" >
                        @foreach ($product->attributes as $image)
                            <div class="item" >
                                <img src="{{ $image->image ? asset('storage/'.$image->image) : asseet('storage/'.$product->product_image) }}"style="height:200px !important" />
                            </div>
                        @endforeach
                ...
                <div class="col-md-6">
                    <div class="product-dtl">
                        <div class="product-info">
                            ...
                            <div class="product-price-discount"><span>{{ money($product->price) }}</span></div>
                        </div>
                        <p>{{ $product->description }}</p>

                        <div class="product-count">
                            <label for="size">Quantity</label>
                            <form action="{{ route('add.to.cart', $product) }}" class="" method="POST"
