...
@section('title')
    <title> How To Become Vendor </title>
@endsection
...
@section('content')
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Become Vendor</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{{ asset('assets/img/LOGOSLOG.png') }}"
                            class="img-fluid blur-up lazyloaded" alt=""></div>
                </div>
                <div class="col-sm-12">
                    ...
                    <p>
                        Janiya reimagines the eclectic visual heritage of Africa. Through innovative and artful elevation,
                        we design contemporary luxury apparel and accessories for a global audience.
                        Inspired by and dedicated to local craftsmanship and artisanry, we collaborate with local and
                        continental suppliers to empower a new generation of creatives. Janiya champions premium quality,
                        100% Made in Rwanda fashion.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <section class="service section-b-space pt-0 ">
            <div class="row partition4 ">
                ...
                <div class="col-lg-3 col-md-6 service-block1 ">
                    ...
                    <h4>verify your social media</h4>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. </p>
                </div>
                <div class="col-lg-3 col-md-6 service-block1 border border-0">
                    ...
                    <h4>account review and confirmatioon</h4>
                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. </p>
                </div>
                <div class="col-lg-3 col-md-6 service-block1 border border-0">
    ...
    <section class="section-b-space become-vendor">
        <div class="container">
            <h4>doing business on janiya shops is really easy</h4>
            <div class="step-bg">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="step-box">
        ...
        <div class="container" bis_skin_checked="1">
            <div class="col" bis_skin_checked="1">
                <div bis_skin_checked="1">
                    <h4>start selling</h4>
                    <p>Janiyashops marketplace is Rwanda’s leading platform for selling online. Be it a manufacturer,
                        vendor or
                        supplier, simply sell products online on Janiyashops and become a top ecommerce player with
                        minimum investment. Through a team of experts offering exclusive seller workshops, training,
                        seller
                        support and convenient seller portal, Janiyashops focuses on educating and empowering sellers
                        across
                        Rwanda.
                        Selling on Janiyashops.com is easy and absolutely free. All you need is to register, list your
                        catalogue and start selling your products.</p>
                    @livewire('become-vendor')
                </div>
            </div>
        </div>
    </section>
