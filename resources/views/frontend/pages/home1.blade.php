        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-start p-right">
                    ...
                    <img src="{{ asset('assets/img/BED3.png') }}" alt="" class="bg-img blur-up lazyload ">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        ...
                                        <h1 style="color: #fff">Best Selling</h1><a href="#"
                                            class="btn btn-outline btn-classic">shop
                                            now</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div>
                <div class="home text-start p-right">
                    ...
                    <img src="{{ asset('assets/img/KD2.png') }}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
...
<section class="banner-padding absolute-banner pb-0 tools-service">
        <div class="container absolute-bg" bis_skin_checked="1">
            <div class="service p-0 " bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-lg-3 col-sm-6 service-block" bis_skin_checked="1">
        ...
        <div class="container" bis_skin_checked="1">
            <div class="row" bis_skin_checked="1">
                <div class="col" bis_skin_checked="1">
                    <div class="slide-4 category-m no-arrow slick-initialized slick-slider" bis_skin_checked="1"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" aria-disabled="false" style="display: inline-block;">Previous</button><div class="slick-list draggable" bis_skin_checked="1"><div class="slick-track" style="opacity: 1; width: 1745px; transform: translate3d(-349px, 0px, 0px);" bis_skin_checked="1"><div class="slick-slide" data-slick-index="0" aria-hidden="true" style="width: 349px;" bis_skin_checked="1" tabindex="-1"><div bis_skin_checked="1"><div style="width: 100%; display: inline-block;" bis_skin_checked="1">
                            <div class="category-wrapper" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                                    <div class="bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/watch/cat1.png&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
                                        <img src="../assets/images/watch/cat1.png" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                    </div>
                                    <h4>watch models</h4>
                                    <ul class="category-link">
                                        <li><a href="#" tabindex="-1">d1 milano</a></li>
                                        <li><a href="#" tabindex="-1">damaskeening</a></li>
                                        <li><a href="#" tabindex="-1">diving watch</a></li>
                                        <li><a href="#" tabindex="-1">dollar watch</a></li>
                                    </ul><a href="#" class="btn btn-outline" tabindex="-1">view more</a>
                                </div>
                            </div>
                        </div></div></div><div class="slick-slide slick-current slick-active" data-slick-index="1" aria-hidden="false" style="width: 349px;" bis_skin_checked="1"><div bis_skin_checked="1"><div style="width: 100%; display: inline-block;" bis_skin_checked="1">
                            <div class="category-wrapper" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                                    <div class="bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/watch/cat2.png&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
                                        <img src="../assets/images/watch/cat2.png" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                    </div>
                                    <h4>calculator watch</h4>
                                    <ul class="category-link">
                                        <li><a href="#" tabindex="0">Shock-resistant watch</a></li>
                                        <li><a href="#" tabindex="0">Skeleton watch</a></li>
                                        <li><a href="#" tabindex="0">Slow watch</a></li>
                                        <li><a href="#" tabindex="0">Solar-powered watch</a></li>
                                    </ul><a href="#" class="btn btn-outline" tabindex="0">view more</a>
                                </div>
                            </div>
                        </div></div></div><div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 349px;" bis_skin_checked="1"><div bis_skin_checked="1"><div class="category-wrapper" style="width: 100%; display: inline-block;" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/watch/cat3.png&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
                                    <img src="../assets/images/watch/cat3.png" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                                <h4>Antimagnetic watch</h4>
                                <ul class="category-link">
                                    <li><a href="#" tabindex="0">Watchmaking conglomerates</a></li>
                                    <li><a href="#" tabindex="0">Breitling SA</a></li>
                                    <li><a href="#" tabindex="0">Casio watches</a></li>
                                    <li><a href="#" tabindex="0">Citizen Watch</a></li>
                                </ul><a href="#" class="btn btn-outline" tabindex="0">view more</a>
                            </div>
                        </div></div></div><div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false" style="width: 349px;" bis_skin_checked="1"><div bis_skin_checked="1"><div class="category-wrapper" style="width: 100%; display: inline-block;" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/watch/cat2.png&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
                                    <img src="../assets/images/watch/cat2.png" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                                ...
                                <ul class="category-link">
                                    <li><a href="#" tabindex="0">Manufacture d'horlogerie</a></li>
                                    <li><a href="#" tabindex="0">Mechanical watch</a></li>
                                    <li><a href="#" tabindex="0">Microbrand watches</a></li>
                                    <li><a href="#" tabindex="0">MIL-W-46374</a></li>
                                </ul><a href="#" class="btn btn-outline" tabindex="0">view more</a>
                            </div>
                        </div></div></div><div class="slick-slide slick-active" data-slick-index="4" aria-hidden="false" style="width: 349px;" bis_skin_checked="1"><div bis_skin_checked="1"><div class="category-wrapper" style="width: 100%; display: inline-block;" bis_skin_checked="1">
                            <div bis_skin_checked="1">
                                <div class="bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/watch/cat1.png&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
                                    <img src="../assets/images/watch/cat1.png" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                                <h4>watch models</h4>
                                <ul class="category-link">
                                    <li><a href="#" tabindex="0">d1 milano</a></li>
                                    <li><a href="#" tabindex="0">damaskeening</a></li>
                                    <li><a href="#" tabindex="0">diving watch</a></li>
                                    <li><a href="#" tabindex="0">dollar watch</a></li>
                                </ul><a href="#" class="btn btn-outline" tabindex="0">view more</a>
                            </div>
    ...
    {{-- <section class="pt-3 ratio3_2">
        <div class="container-fluid p-0" bis_skin_checked="1">
            <div class="row m-0" bis_skin_checked="1">
                <div class="col-lg-3 col-sm-6 p-0" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-left" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/MEN.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/MEN.png') }}" class="img-fluid blur-up lazyload bg-img"
                                    style="display: none; width: 3rem">
                            </div>
                            <div class="contain-banner banner-4" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                                    <h4>save 60%</h4>
                ...
                <div class="col-lg-3 col-sm-6 p-0" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-left" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/WOMEN.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/WOMEN.png') }}" class="img-fluid blur-up lazyload bg-img"
                                    style="display: none;">
                            </div>
                            <div class="contain-banner banner-4" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                ...
                <div class="col-lg-3 col-sm-6 p-0" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-left" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/KD.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/KD.png') }}" class="img-fluid blur-up lazyload bg-img"
                                    style="display: none;">
                            </div>
                            <div class="contain-banner banner-4" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                ...
                <div class="col-lg-3 col-sm-6 p-0" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-left" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/BEDS.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/BEDS.png') }}" class="img-fluid blur-up lazyload bg-img"
                                    style="display: none;">
                            </div>
                            <div class="contain-banner banner-4" bis_skin_checked="1">
                                <div bis_skin_checked="1">
    ...
    <div class="title6 section-t-space" bis_skin_checked="1">
        <h2 class="font-fraunces">top collection</h2>
    </div>
    <div class="container" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div class="col-lg-6 offset-lg-3" bis_skin_checked="1">
                <div class="product-para" bis_skin_checked="1">
                    ...
                    <div class="product-box product-wrap product-style-3" bis_skin_checked="1">
                        <div class="img-wrapper" bis_skin_checked="1">
                            <div class="front" bis_skin_checked="1">
                                <a href="{{ route('al_product_details', Crypt::encryptString($product->id)) }}"
                                    ...
                                    style="background-image: url({{ $product->product_image ? $product->product_image : asset('assets/images/2.jpg') }}); background-size: cover; background-position: center center; display: block;"
                                    bis_skin_checked="1"><img alt=""
                                        src="{{ $product->thumb()->exists() ? $product->thumb->image : asset('assets/images/2.jpg') }}"
                            ...
                            <div class="cart-detail" bis_skin_checked="1"><a href="javascript:void(0)"
                                    title="Add to Wishlist" bis_skin_checked="1"><i class="ti-heart"
                                        aria-hidden="true"></i></a> <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#quick-view" title="Quick View"><i class="ti-search"
                                        aria-hidden="true"></i></a> <a href="compare.html" title="Compare"
                                    bis_skin_checked="1"><i class="ti-reload" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="product-info" bis_skin_checked="1">
                            ...
                            <div class="add-btn" bis_skin_checked="1">
                                <a href="javascript:void(0)" class="" bis_skin_checked="1">
    ...
    <!-- collection banner end -->
<section class="p-0">
        <div class="full-banner banner-layout-3 parallax text-center p-center bg-size blur-up lazyloaded" style="background-image: url(&quot;{{ asset('assets/img/1.png') }}&quot;); background-size: cover; background-position: center center; display: block;" bis_skin_checked="1">
            <img src="{{ asset('assets/img/1.png') }}" alt="" class="bg-img blur-up lazyload" style="display: none;">
            <div class="container" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col" bis_skin_checked="1">
                        <div class="banner-contain" bis_skin_checked="1">
                            <h4 class="color pt-0">special offer for you</h4>
                            <h3>leather bag</h3>
                            <h4>extra 50% off</h4> <a href="#" class="btn btn-solid">shop now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container" bis_skin_checked="1">
            <div class="row" bis_skin_checked="1">
                <div class="col-12" bis_skin_checked="1">
                    <div class="title-basic" bis_skin_checked="1">
                        <h2 class="title font-fraunces"><i class="ti-bolt"></i>Don't Miss These bedsheet</h2>
                    </div>
                </div>
                <div class="col-12" bis_skin_checked="1">
                    <div class="slide-6-product product-m no-arrow slick-initialized slick-slider" bis_skin_checked="1">
                        <div class="slick-list draggable" bis_skin_checked="1">
                            <div class="slick-track"
                                ...
                                <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false"
                                    style="width: 234px;" bis_skin_checked="1">
                                    <div bis_skin_checked="1">
                                        <div class="product-box product-wrap product-style-3"
                                            style="width: 100%; display: inline-block;" bis_skin_checked="1">
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/44.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                            ...
                                            <div class="product-info" bis_skin_checked="1">
                                                ...
                                                <a href="product-page(no-sidebar).html" tabindex="0"
                                                    bis_skin_checked="1">
                                                    <h6>Multicolor Classic Backpack</h6>
                                                </a>
                                                <h4>$80.30</h4>
                                                <div class="add-btn" bis_skin_checked="1">
                                                    <a href="javascript:void(0)" class="" tabindex="0"
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/45.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/46.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/47.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/48.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                ...
                <div class="col-12 section-t-space" bis_skin_checked="1">
                    <div class="title-basic" bis_skin_checked="1">
                        <h2 class="title font-fraunces"><i class="ti-bolt"></i> Trending towels</h2>
                    </div>
                </div>
                <div class="col-12" bis_skin_checked="1">
                    <div class="slide-6-product product-m no-arrow slick-initialized slick-slider" bis_skin_checked="1">
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/49.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/50.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/1.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/3.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                        ...
                                        <div class="product-box product-wrap product-style-3"
                                            ...
                                            <div class="img-wrapper" bis_skin_checked="1">
                                                <div class="front" bis_skin_checked="1">
                                                    <a href="product-page(no-sidebar).html"
                                                        class="bg-size blur-up lazyloaded"
                                                        style="background-image: url(&quot;../assets/images/marketplace/pro/4.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                                        tabindex="0" bis_skin_checked="1"><img alt=""
                                                ...
                                                <div class="cart-detail" bis_skin_checked="1"><a
                                                        ...
                                                        tabindex="0" bis_skin_checked="1"><i class="ti-heart"
                                                            aria-hidden="true"></i></a> <a href="#"
                                                        data-bs-toggle="modal" data-bs-target="#quick-view"
                                                        title="Quick View" tabindex="0"><i class="ti-search"
                                                            aria-hidden="true"></i></a> <a href="compare.html"
    ...
    <section class="pb-0 ratio2_1">
        <div class="container" bis_skin_checked="1">
            <div class="row partition2" bis_skin_checked="1">
                <div class="col-md-6" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-right text-end" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;../assets/images/marketplace/banner/13.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="../assets/images/marketplace/banner/13.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                            </div>
                            <div class="contain-banner" bis_skin_checked="1">
                                <div bis_skin_checked="1">
                                    <h4>save 30%</h4>
                                    <h2>sale</h2>
                                </div>
                ...
                <div class="col-md-6" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-right text-center" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;../assets/images/marketplace/banner/14.jpg&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
    ...
    <section class="service section-b-space bg-light">
        <div class="container" bis_skin_checked="1">
            <div class="row partition4 " bis_skin_checked="1">
                <div class="col-lg-3 col-md-6 service-block1" bis_skin_checked="1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -117 679.99892 679">
                        <path
                ...
                <div class="col-lg-3 col-md-6 service-block1 border border-0" bis_skin_checked="1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -14 512.00001 512">
                        <path
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center">Looking for the latest trends in clothing, shoes and accessories? Welcome to our
                        'Latest Drops' edit, bringing you all the latest styles from all your fave brands.</p>
                </div>
            </div>
        </div>
    </div> --}}
                                            ...
                                            @forelse ($item->products()->limit(4)->inRandomOrder()->get() as $product)
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        <div class="front">
                                                            <a
                                                                href="{{ route('al_product_details', Crypt::encryptString($product->id)) }}"><img
                                                        ...
                                                        <div class="cart-info cart-wrap">
                                                            ...
                                                            <a href="#" data-bs-toggle="modal"
                                                                ...
                                                                tabindex="0"><i class="ti-search"
                                                                    aria-hidden="true"></i></a>
                                                            <a href="compare.html" title="Compare" tabindex="0"><i
                                                                    class="ti-reload" aria-hidden="true"></i></a>
                                                        </div>
                                                        <div class="add-button" data-bs-toggle="modal"
                                                    ...
                                                    <div class="product-detail">
                                                        ...
                                                        <a
                                                            href="{{ route('al_product_details', Crypt::encryptString($product->id)) }}">
