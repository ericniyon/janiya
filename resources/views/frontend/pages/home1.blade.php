            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/1.jpg" class="bg-img"
                                        alt="img">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/2.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/3.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/4.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/5.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/6.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider/marketplace/7.jpg" class="bg-img"
                                        alt="img">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
