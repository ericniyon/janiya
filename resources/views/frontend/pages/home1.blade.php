...
@section('content')
    ...
    <!-- collection banner end -->
    <section class="p-0">
        <div class="full-banner banner-layout-3 parallax text-center p-center bg-size blur-up lazyloaded"
            style="background-image: url(&quot;{{ asset('assets/img/1.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
            bis_skin_checked="1">
            <img src="{{ asset('assets/img/1.png') }}" alt="" class="bg-img blur-up lazyload"
                style="display: none;">
            <div class="container" bis_skin_checked="1">
