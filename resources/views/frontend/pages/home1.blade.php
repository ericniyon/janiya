                ...
                <div class="row" bis_skin_checked="1">
                    <div class="col" bis_skin_checked="1">
                        <div class="banner-contain" bis_skin_checked="1">
                            ...
                            <h3>leather bag</h3>
                            <h4>extra 50% off</h4> <a href="{{ url('shops') }}" class="btn btn-solid">shop now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <a href="#">
                        <div class="collection-banner p-right text-end" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/DALVINE 2.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/DALVINE 2.png') }}"
                ...
                <div class="col-md-6" bis_skin_checked="1">
                    <a href="#">
                        <div class="collection-banner p-right text-center" bis_skin_checked="1">
                            <div class="img-part bg-size blur-up lazyloaded"
                                style="background-image: url(&quot;{{ asset('assets/img/BH0.png') }}&quot;); background-size: cover; background-position: center center; display: block;"
                                bis_skin_checked="1">
                                <img src="{{ asset('assets/img/BH.png') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                            </div>
                            <div class="contain-banner" bis_skin_checked="1">
                                <div bis_skin_checked="1">
