    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home text-start p-left">
                <img src="../assets/images/home-banner/33.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <div>
            <div class="home text-start p-right">
                <img src="../assets/images/home-banner/32.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4>save upto 20%</h4>
                                    <h1>new collection</h1><a href="#" class="btn btn-outline btn-classic">shop
                                        now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col">
                    ...
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-7">featured</a></li>
                            <li class=""><a href="tab-8">best product</a></li>
                            <li class=""><a href="tab-9">sale product</a></li>
                        </ul>
                ...
                <div class="slide-3 no-arrow">
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="../assets/images/nursery/1.jpg"
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="../assets/images/nursery/2.jpg"
                                        class="img-fluid blur-up lazyload bg-img">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="../assets/images/nursery/3.jpg"
                                        class="img-fluid blur-up lazyload bg-img">
                                </div>
                                <span></span>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                ...
                <div class="slide-7 no-arrow slick-instagram">
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/1.jpg"
                                    style="width:100%">
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/2.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/4.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/10.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/6.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/7.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"><img alt="" src="../assets/images/slider/nursery/8.jpg"
                                    style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
